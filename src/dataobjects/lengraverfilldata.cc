...
void LEngraverFillData::dump_out(FILE *f,int indent,int what,Laxkit::DumpContext *context)
{
...
Laxkit::Attribute *LEngraverFillData::dump_out_atts(Laxkit::Attribute *att,int what,Laxkit::DumpContext *context)
{
 ...
 */
void LEngraverFillData::dump_in_atts(Laxkit::Attribute *att,int flag,Laxkit::DumpContext *context)
{
