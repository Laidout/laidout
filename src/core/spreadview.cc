 ...
 */
void SpreadView::dump_out(FILE *f,int indent,int what,Laxkit::DumpContext *context)
{
...
//! Load.
void SpreadView::dump_in_atts(Laxkit::Attribute *att,int flag,Laxkit::DumpContext *context)
{
	if (!att) return;
	char *name,*value;
	double m[6];
